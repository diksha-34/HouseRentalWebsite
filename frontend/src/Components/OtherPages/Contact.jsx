...
const links = [
  { name: 'Search Houses', href: '#' },
  { name: 'Provide Suggestion', href: '#' },
  { name: 'Structure', href: '#' },
  { name: 'Dealing', href: '#' },
]
const stats = [
  { name: 'Provide India', value: '12' },
  { name: 'Full-time colleagues', value: '300+' },
  { name: 'Review', value: 'Unlimited' },
  { name: 'Subscription', value: '1 Year' },
]
      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-black-500">
            We're here to help you find your ideal rental home. Whether you have inquiries about our listings, need assistance with your rental application, or just want to say hello, feel free to reach out to us. Our team is dedicated to providing exceptional customer service and ensuring your renting experience is smooth and hassle-free.
            </p>
          </div>
            ...
            <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.name} className="flex flex-col-reverse">
                  <dt className="text-base leading-7 text-black-500">{stat.name}</dt>
